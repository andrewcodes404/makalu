...
const Terms = () => (
    <div className="page-content legal">
        <div className="mt3">
            <h1>Terms and conditions of use</h1>
            <h2>Introduction</h2>
            <p >These terms and conditions apply between you, the User of this Website (including any sub-domains, unless expressly excluded by their own terms and conditions), and CountdownCals.com, the owner and operator of this Website. Please read these terms and conditions carefully, as they affect your legal rights. Your agreement to comply with and be bound by these terms and conditions is deemed to occur upon your first use of the Website. If you do not agree to be bound by these terms and conditions, you should stop using the Website immediately.</p>
            <p >In these terms and conditions, <b>User</b> or <b>Users</b> means any third party that accesses the Website and is not either (i) employed by CountdownCals.com and acting in the course of their employment or (ii) engaged as a consultant or otherwise providing services to CountdownCals.com and accessing the Website in connection with the provision of such services.</p>
            ...
            <ul>
                ...
                <li >You must not otherwise reproduce, modify, copy, distribute or use for commercial purposes any Content without the written permission of CountdownCals.com.</li>
                ...
                <li >You represent and warrant that you own or otherwise control all the rights to the Content you post; that the Content is accurate; that use of the Content you supply does not violate any provision of these terms and conditions and will not cause injury to any person; and that you will indemnify CountdownCals.com for all claims resulting from Content you supply.</li>
            </ul>
            ...
            <ul>
                <li >This Website may contain links to other sites. Unless expressly stated, these sites are not under the control of CountdownCals.com or that of our affiliates.</li>
            ...
            <ul>
                <li >Use of the Website is also governed by our Privacy Policy and Cookies Policy, which are incorporated into these terms and conditions by this reference. To view the Privacy Policy and Cookies Policy, please click on the following: https://countdowncals.com/privacy_policy and https://countdowncals.com/cookies_policy.</li>
            </ul>
            <h2>Availability of the Website and disclaimers</h2>
            <ul>
                <li >Any online facilities, tools, services or information that CountdownCals.com makes available through the Website (the <b>Service</b>) is provided "as is" and on an "as available" basis. We give no warranty that the Service will be free of defects and/or faults. To the maximum extent permitted by the law, we provide no warranties (express or implied) of fitness for a particular purpose, accuracy of information, compatibility and satisfactory quality. CountdownCals.com is under no obligation to update information on the Website.</li>
                <li >Whilst CountdownCals.com uses reasonable endeavours to ensure that the Website is secure and free of errors, viruses and other malware, we give no warranty or guaranty in that regard and all Users take responsibility for their own security, that of their personal details and their computers.</li>
                <li >CountdownCals.com accepts no liability for any disruption or non-availability of the Website.</li>
                <li >CountdownCals.com reserves the right to alter, suspend or discontinue any part (or the whole of) the Website including, but not limited to, any products and/or services available. These terms and conditions shall continue to apply to any modified version of the Website unless it is expressly stated otherwise.</li>
            </ul>
            ...
            <ul>
                ...
                <li >To the extent that the Website and Content are provided free of charge, we will not be liable to you for any loss or damage of any kind.</li>
                <li >We will not be liable to you in respect of any losses arising out of events beyond our reasonable control.</li>
                <li >To the maximum extent permitted by law, CountdownCals.com accepts no liability for any of the following:&nbsp;</li>
                <ul >
            ...
            <p >CountdownCals.com details</p>
            <ul>
                <li >CountdownCals.com of The Levels, Peckham Town Centre Carpark, 95A Rye Lane, London, SE15 4ST  operates the Website https://countdowncals.com/.&nbsp;</li>
            </ul>
            <p >You can contact CountdownCals.com by email on hello@countdowncals.com.</p>
            <p >Attribution</p>
            <ul>
                <li >These terms and conditions were created using a document from Rocket Lawyer (https://www.rocketlawyer.co.uk).</li></ul>
        </div>
    </div>
);
