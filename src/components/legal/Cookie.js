...
const Cookie = () => (
    ...
    <div className="mt3">
        ...
        <h1>Cookie Policy for CountdownCals</h1>

        <p>This is the Cookie Policy for CountdownCals, accessible from https://countdowncals.com/</p>
        ...
        <ul>
            <li>Email: hello@countdowncals.com</li>
