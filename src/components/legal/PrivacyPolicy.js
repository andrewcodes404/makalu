...
const PrivacyPolicy = () => (
        <div className="page-content legal">
                ...
                <div className="mt3">
                        ...
                        <p>Countdown Cals ("us", "we", or "our") operates the https://countdowncals.com/ website (the "Service").</p>

                        <p>This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use
                            our Service and the choices you have associated with that data. Our Privacy Policy for Countdown Cals is managed
    through <a href="https://www.freeprivacypolicy.com/free-privacy-policy-generator.php">Free Privacy Policy Website</a>.</p>
    ...
    Privacy Policy have the same meanings as in our Terms and Conditions, accessible from https://countdowncals.com/</p>
    ...
    not accept cookies, you may not be able to use some portions of our Service.</p>
        ...
        settings.</li>
                        ...
                        <p>Countdown Cals uses the collected data for various purposes:</p>
                        <ul>
    ...
    that transfer.</p>
                        <p>Countdown Cals will take all steps reasonably necessary to ensure that your data is treated securely and in
    ...
    information.</p>
                        ...
                        <p>Countdown Cals may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                        <ul>
                                <li>To comply with a legal obligation</li>
                                <li>To protect and defend the rights or property of Countdown Cals</li>
